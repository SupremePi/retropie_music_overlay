...
infobox="${infobox}\n"
infobox="${infobox}RetroPie Background Music Python Script\n\n"
...
infobox="${infobox}\n"
infobox="${infobox}A special new folder has been created in the /music directory called \"custom\" for placing your MP3 files into.\n"
infobox="${infobox}\n"
