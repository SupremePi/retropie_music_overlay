...
musicdirac = '~/RetroPie/roms/music/arcade'
musicdirbttf = '~/RetroPie/roms/music/bttf'
musicdircustom = '~/RetroPie/roms/music/custom'
musicdirnt = '~/RetroPie/roms/music/nt'
musicdirst = '~/RetroPie/roms/music/st'
musicdiruvf = '~/RetroPie/roms/music/uvf'
musicdirvenom = '~/RetroPie/roms/music/venom'
musicdiroff = '~/RetroPie/roms/music'
musicdir = musicdiroff # "~/" is the equivalent to "~"
maxvolume = 0.50
...
### if ~ is used, change it to home directory (EXAMPLE: "~/BGM" to "~/BGM")
if "~/" in musicdir:
...
while True:
	...
	if os.path.exists('~/RetroPie/roms/music/DisableMusic'):
		print "DisableMusic found!"
		if mixer.music.get_busy():
			mixer.music.stop();
		while (os.path.exists('~/RetroPie/roms/music/DisableMusic')):
			time.sleep(15)
